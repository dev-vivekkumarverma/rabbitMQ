...
import time, random
from constants import (EXCHANGE, GENERAL_ROUTING_KEY)
...
channel.queue_bind(queue=queue_name,routing_key=GENERAL_ROUTING_KEY,exchange=EXCHANGE)
channel.basic_qos(prefetch_count=1)

print(f"[*] stated consuming general-consumer-messages from {queue_name} queue and Exchange {EXCHANGE} ...")
