...
import time, random
from constants import (EXCHANGE, PAYMENT_ROUTING_KEY)
...
channel.queue_bind(queue=queue_name,routing_key=PAYMENT_ROUTING_KEY,exchange=EXCHANGE)
channel.basic_qos(prefetch_count=1)

print(f"[*] stated consuming payment-message from {queue_name} queue and Exchange {EXCHANGE} ...")
